...
%This function was generated by loadlibrary.m parser version  on Tue Aug  6 16:23:08 2024
...
% result_t __stdcall set_network_settings ( device_t id , const network_settings_t * network_settings ); 
fcns.thunkname{fcnNum}='int32int32voidPtrThunk';fcns.name{fcnNum}='set_network_settings'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'network_settings_tPtr'};fcnNum=fcnNum+1;
% result_t __stdcall get_network_settings ( device_t id , network_settings_t * network_settings ); 
fcns.thunkname{fcnNum}='int32int32voidPtrThunk';fcns.name{fcnNum}='get_network_settings'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'network_settings_tPtr'};fcnNum=fcnNum+1;
% result_t __stdcall set_password_settings ( device_t id , const password_settings_t * password_settings ); 
fcns.thunkname{fcnNum}='int32int32voidPtrThunk';fcns.name{fcnNum}='set_password_settings'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'password_settings_tPtr'};fcnNum=fcnNum+1;
% result_t __stdcall get_password_settings ( device_t id , password_settings_t * password_settings ); 
fcns.thunkname{fcnNum}='int32int32voidPtrThunk';fcns.name{fcnNum}='get_password_settings'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int32', 'password_settings_tPtr'};fcnNum=fcnNum+1;
...
structs.network_settings_t.members=struct('DHCPEnabled', 'uint32', 'IPv4Address', 'uint32#4', 'SubnetMask', 'uint32#4', 'DefaultGateway', 'uint32#4');
structs.password_settings_t.members=struct('UserPassword', 'int8#21');
...
structs.chart_data_t.members=struct('WindingVoltageA', 'int32', 'WindingVoltageB', 'int32', 'WindingVoltageC', 'int32', 'WindingCurrentA', 'int32', 'WindingCurrentB', 'int32', 'WindingCurrentC', 'int32', 'Pot', 'uint32', 'Joy', 'uint32', 'AveragedPowerRatio', 'int32');
