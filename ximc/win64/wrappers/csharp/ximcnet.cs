...
namespace ximc
{
	...
	{
		public const String version = "2.14.26";
	};
...
*/
	...
	[StructLayout(LayoutKind.Sequential, CharSet=CharSet.Ansi)]
	public struct network_settings_t
	{
	...
	[StructLayout(LayoutKind.Sequential, CharSet=CharSet.Ansi)]
	public struct password_settings_t
	{
...
*/
	...
	public partial class API
	{
		...
		[DllImport("libximc.dll")]
		public static extern Result set_network_settings (int id, ref network_settings_t network_settings);

		[DllImport("libximc.dll")]
		public static extern Result get_network_settings (int id, out network_settings_t network_settings);

		[DllImport("libximc.dll")]
		public static extern Result set_password_settings (int id, ref password_settings_t password_settings);

		[DllImport("libximc.dll")]
		public static extern Result get_password_settings (int id, out password_settings_t password_settings);
