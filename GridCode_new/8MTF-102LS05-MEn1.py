def set_profile_8MTF_102LS05_MEn1(lib, id):
    ...
    home_settings.HomeDelta = 408000
    ...
    engine_settings.Antiplay = -29536
    ...
    edges_settings.LeftBorder = -387600
    edges_settings.uLeftBorder = 0
    edges_settings.RightBorder = 387600
    ...
    control_settings.DeltaPosition = 24
    ...
    emf_settings.L = 0.00540000014007092
    emf_settings.R = 7.40000009536743
    emf_settings.Km = 0.00249999994412065
    class BackEMFFlags_:
        BACK_EMF_KM_AUTO = 4
